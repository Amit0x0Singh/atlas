...
import MicrobesDashboard from "../../pages/microbial/dashboard/page/MicrobesDashboard.jsx";
...
export const dashboardRoutes = [
  ...
  <Route key="microbes-dashboard" path="/microbes-dashboard" element={<MicrobesDashboard />} />,
];
