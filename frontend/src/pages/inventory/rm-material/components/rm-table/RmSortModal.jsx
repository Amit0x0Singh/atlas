...
export const DEFAULT_RM_SORT = { field: 'name', direction: 'asc' }
...
/** Centered popup, same interaction as UsersSortModal. */
export default function RmSortModal({ open, onClose, value, onApply }) {
  return (
    <Modal open={open} onClose={onClose} size="sm">
      ...
      <div className="flex items-center justify-between gap-2 px-5 py-4 border-t border-gray-100 bg-gray-50/60">
        <Button variant="outline-gray" onClick={() => onApply(DEFAULT_RM_SORT)}>Reset</Button>
