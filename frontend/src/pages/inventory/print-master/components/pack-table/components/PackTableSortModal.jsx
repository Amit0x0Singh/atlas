...
export const DEFAULT_PACK_TABLE_SORT = { field: 'receivedDate', direction: 'desc' }
...
export default function PackTableSortModal({ open, onClose, value, onApply }) {
  return (
    <Modal open={open} onClose={onClose} size="sm">
      ...
      <div className="px-5 py-1 max-h-[70vh] overflow-y-auto">
        ...
        <SortGroup title="Bags" field="bags" active={value} onPick={onApply}
      ...
      <div className="flex items-center justify-between gap-2 px-5 py-4 border-t border-gray-100 bg-gray-50/60">
        <Button variant="outline-gray" onClick={() => onApply(DEFAULT_PACK_TABLE_SORT)}>Reset</Button>
