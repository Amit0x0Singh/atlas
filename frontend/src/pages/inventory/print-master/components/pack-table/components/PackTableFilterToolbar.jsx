...
export default function PackTableFilterToolbar({ search, onSearchChange, filters, onFiltersChange, sort, onSortChange, onExport, resultCount }) {
  ...
  const sortIsDefault = sort.field === DEFAULT_PACK_TABLE_SORT.field && sort.direction === DEFAULT_PACK_TABLE_SORT.direction
...
export { EMPTY_PACK_TABLE_FILTERS, DEFAULT_PACK_TABLE_SORT }
