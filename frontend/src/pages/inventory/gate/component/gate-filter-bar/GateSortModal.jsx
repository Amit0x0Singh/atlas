...
export const DEFAULT_GATE_SORT = { field: 'date', direction: 'desc' }
...
export default function GateSortModal({ open, onClose, value, onApply }) {
  return (
    <Modal open={open} onClose={onClose} size="sm">
      ...
      <div className="px-5 py-1 max-h-[70vh] overflow-y-auto">
        ...
        <SortGroup title="Company" field="company" active={value} onPick={onApply}
      ...
      <div className="flex items-center justify-between gap-2 px-5 py-4 border-t border-gray-100 bg-gray-50/60">
        <Button variant="outline-gray" onClick={() => onApply(DEFAULT_GATE_SORT)}>Reset</Button>
