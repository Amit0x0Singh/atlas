      ...
      <div className="w-full max-w-sm bg-white flex flex-col h-full shadow-2xl overflow-hidden">
        ...
        <div className="px-5 py-4 border-t flex gap-2.5 justify-end sticky bottom-0 bg-white">
          <button onClick={onClose}
            className="px-4 py-2 border border-gray-200 rounded-lg text-[13px] font-semibold hover:bg-gray-50">
            Cancel
          </button>
          <button onClick={handleSave}
            className="px-5 py-2 bg-green-600 text-white rounded-lg text-[13px] font-bold hover:bg-green-700">
            Update
          </button>
        </div>
      </div>
