import {
  ...
  ClipboardList, Snowflake, MapPin, ListChecks, ClipboardPen,
  ShoppingBag,
...
export const APP_NAV = [
  {
    ...
    items: [
      ...
      { to: '/rm-material',        label: 'Item Inventory',  Icon: Package },
      { to: '/microbes-dashboard', label: 'Microbial Inventory',        Icon: Microscope },
    ],
  },
  {
    group: 'MASTER DATA',
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/material-indent', label: 'Material Indent',  Icon: ClipboardPen },
