...
export function registerRoutes(app) {
  ...
  app.use('/api/masters',               erpMastersRoutes)
  app.use('/api/gate',                  erpGateRoutes)
  app.use('/api/inventory',             erpInventoryRoutes)
  app.use('/api/sales',                 erpSalesRoutes)
  app.use('/api/planning',              erpPlanningRoutes)
  app.use('/api/bom-issuance',          erpBomIssuanceRoutes)
  app.use('/api/microbial',             erpMicrobialRoutes)
  app.use('/api/notifications',         erpNotifRoutes)
  app.use('/api/export',                erpExportRoutes)
  app.use('/api/employees',             erpEmployeeRoutes)
  app.use('/api/sales-orders',          erpSalesOrderRoutes)
  app.use('/api/plan-engine',           erpPlanEngineRoutes)
