...
import { validateCreateSfgInward, validateImportSfgInward } from "./create/sfg-inward.middleware.js";
import { updateSfgInward } from "./update/sfg-inward.controller.js";
import { validateUpdateSfgInward } from "./update/sfg-inward.middleware.js";
...
SfgInwardRouter.post("/microbial-sfg/inward/import", authorize("microbial.sfg-inward.import"), validateImportSfgInward, importSfgInward);
SfgInwardRouter.put("/microbial-sfg/inward/:id", authorize("microbial.sfg-inward.update"), validateUpdateSfgInward, updateSfgInward);
SfgInwardRouter.get("/microbial-sfg/inward", canView, listSfgInward);
SfgInwardRouter.post("/microbial-sfg/inward", authorize("microbial.sfg-inward.create"), validateCreateSfgInward, createSfgInward);
