...
export const createRm = async (req, res) => {
  try {
    ...
    // The Conversion Factor (Inventory UOM per one Operation UOM) is only
    // meaningful — and only required — when the two UOMs actually differ;
    // same-unit items never need one.
