...
InwardRouter.get('/packs/label/:packId', authenticate, getPackLabel)
InwardRouter.get('/packs/labels/lot/:itemCode/:lotNo', authenticate, getBatchLabels)
InwardRouter.get('/packs/labels/batch', authenticate, getBatchLabelsMulti)
