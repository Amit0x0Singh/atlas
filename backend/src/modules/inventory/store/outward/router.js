...
import { bomScan, bomManual, packReduction, stockAdjustment, bagLossAdjustment, containerLossAdjustment, warehouseTransfer, directIssue, bomDirectIssue, upsertBomSession, deleteBomSession } from './create/outward.controller.js'
import {
  validateBomScan, validateBomManual, validatePackReduction, validateStockAdjustment,
  validateBagLossAdjustment, validateContainerLossAdjustment, validateWarehouseTransfer, validateDirectIssue, validateBomDirectIssue,
...
OutwardRouter.post('/container-loss-adjustment', canCreate, validateContainerLossAdjustment, containerLossAdjustment)
