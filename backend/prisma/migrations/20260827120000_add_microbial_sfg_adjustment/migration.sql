...
-- only (loss_qty_kg is always the positive magnitude removed).
...
CREATE INDEX IF NOT EXISTS "microbial_sfg_adjustment_adjusted_at_idx"  ON "microbial_sfg_adjustment"("adjusted_at");
